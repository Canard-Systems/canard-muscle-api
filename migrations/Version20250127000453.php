...
final class Version20250127000453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session_exercise ADD CONSTRAINT FK_2576B574E934951A FOREIGN KEY (exercise_id) REFERENCES exercise (id)');
        ...
        $this->addSql('ALTER TABLE exercise ADD description LONGTEXT DEFAULT NULL, ADD muscles VARCHAR(255) DEFAULT NULL, DROP session_id, DROP sets, DROP reps_per_set, DROP duration, DROP weight');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercise ADD session_id INT NOT NULL, ADD sets INT NOT NULL, ADD reps_per_set JSON DEFAULT NULL, ADD duration INT DEFAULT NULL, ADD weight DOUBLE PRECISION DEFAULT NULL, DROP description, DROP muscles');
        $this->addSql('ALTER TABLE exercise ADD CONSTRAINT FK_AEDAD51C613FECDF FOREIGN KEY (session_id) REFERENCES session (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
